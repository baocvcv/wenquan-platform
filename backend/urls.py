...
urlpatterns = [
    ...
    path(r'api/paper_records/', views.PaperRecordList.as_view(), name="paper_record_list"),
    path(r'api/paper_records/<int:pk>', views.PaperRecordDetail.as_view(), name="paper_record_detail"),
]
