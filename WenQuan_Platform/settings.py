"""
Django settings for WenQuan_Platform project.
...
SECRET_KEY = 'hu)%(uu94fs_3tfex73@&(757_vw3^_tb$-o61%7au+d)yr$ni'
...
WSGI_APPLICATION = 'WenQuan_Platform.wsgi.application'
