    ...
    computed: {
        ...
        allLeafsSelected() {
            return this.hasChildren && this.hasSelection &&
                this.allLeafs.every(leaf => this.value.some(leafItem => leafItem === leaf));
        },
        someLeafsSelected() {
            return this.hasChildren && this.hasSelection &&
                this.allLeafs.some(leaf => this.value.some(leafItem => leafItem === leaf));
        },
        indeterminate() {
            return this.hasChildren && this.hasSelection &&
                this.someLeafsSelected && !this.allLeafsSelected;
        }
    },
