...
describe("QuestionBank.vue", () => {
    ...
    beforeEach(() => {
        ...
        router = new Router({
            routes: [
                { path: "/admin/questionbanks/:id", name: "question-bank", component: QuestionBank},
                { path: "/", component: Home}
            ]
        }
        )
    ...
    it("Can cancel and save in edit mode", async (done) => {
        ...
        setTimeout(async () => {
            ...
            {
                if (buttons.at(i).text() === "Cancel")
                    cancel_button = buttons.at(i);
                else if (buttons.at(i).text() === "Save")
                    save_button = buttons.at(i);
            }
